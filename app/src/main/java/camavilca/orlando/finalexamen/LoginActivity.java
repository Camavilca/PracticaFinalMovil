...
public class LoginActivity extends AppCompatActivity {
                    ...
                    public void onComplete(@NonNull Task<AuthResult> task) {
                        ...
                        if (!task.isSuccessful()) {
                            ...
                            Toast.makeText(LoginActivity.this, "\n" +
                                    "Nombre de usuario y/o contraseña inválida", Toast.LENGTH_SHORT).show();
                        }
                    }
                });
    }
    public void callRegister(View view){
        ...
        if(password.length() < 6){
            Toast.makeText(this, "\n" +
                    "Usando una contraseña débil", Toast.LENGTH_SHORT).show();
            return;
        }
        ...
        mAuthListener = new FirebaseAuth.AuthStateListener() {
            ...
            public void onAuthStateChanged(@NonNull FirebaseAuth firebaseAuth) {
                ...
                if (user != null) {
                    ...
                    Toast.makeText(LoginActivity.this, "Bienvenido a nuestra app " + user.getDisplayName(), Toast.LENGTH_SHORT).show();
    ...
    private void initGoogleSignIn(){
        ...
        GoogleSignInOptions gso = new GoogleSignInOptions.Builder(GoogleSignInOptions.DEFAULT_SIGN_IN)
                .requestIdToken("3***********-********CAMBIAME!!!.apps.googleusercontent.com")
                .requestEmail()
                .build();
